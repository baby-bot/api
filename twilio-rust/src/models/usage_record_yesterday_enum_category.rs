...
impl ToString for UsageRecordYesterdayEnumCategory {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::TtsGoogle => String::from("tts-google"),
            ...
            Self::VoiceIntelligence => String::from("voice-intelligence"),
            Self::VoiceIntelligenceTranscription => String::from("voice-intelligence-transcription"),
            Self::VoiceIntelligenceOperators => String::from("voice-intelligence-operators"),
...
impl Default for UsageRecordYesterdayEnumCategory {
    fn default() -> UsageRecordYesterdayEnumCategory {
